...
NOTE: SCPI is an interface for remotely controlling the VNA Control 5 software. Therefore, please ensure that
the VNA Control 5 software is running before running any SCPI example programs.

NOTE: This example involves applying a calibration and therefore must be run with a real LA Techniques VNA instrument.
...
if __name__ == '__main__':
    ...
    # Change the path to point to a directory containing a valid VNA Control 5 calibration
    vna.query('MMEM:CD /path/to/directory/of/calibration')

    # Now apply the user calibration
    # Change the name to that of a valid VNA Control 5 calibration
