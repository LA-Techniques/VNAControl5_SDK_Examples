...
the VNA Control 5 software is running before running any SCPI example programs. The examples may be run using
a simulated demonstration device for evaluation purposes if no LA Techniques VNA instrument is available.
"""
