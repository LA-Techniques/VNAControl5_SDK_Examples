...
% NOTE: SCPI is an interface for remotely controlling the VNA Control 5
% software. Therefore, please ensure that the VNA Control 5 software is
% running before running any SCPI example programs.

% NOTE: This example involves applying a calibration and therefore
% must be run with a real LA Techniques VNA instrument. This example will not
